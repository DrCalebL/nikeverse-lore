...
| W9 ✅ **FIXED (2026-08-25)** | **Free's end-state — the freed soul's fate** | `CANON.md` §5.1 (FROZEN) said *"Reached, and then **left wild**"* — the soul stays roaming | the build ruled *"Free **returns the soul to the Pattern**"* (owner 2026-07-28, `Nikeverse-mmo-rpg-from-scratch/docs/KNOWN_ISSUES.md` Q7); `GAME_SPEC.md` §4.5.8 implements it — the soul is healed, **leaves the world**, its spawn point later carries a new life, and it leaves the **Strand** | **The build was right; the lore's FROZEN §5.1 was the stale side and was never swept — surfaced by the wave-4 seal-despawn (`SEAL_MOMENT_SPEC.md` §8 Q1).** RECONCILED by owner ruling 2026-08-25: `CANON.md` §5.1's second end amended to *"Reached, and then let go… returns to the Pattern"*, its "free" precision box updated, and two stale from-scratch story docs swept (`OPENWORLD_AND_ENDLESS.md` §free-wilds · `CAMPAIGN_AND_COMPANIONS.md` Nel). `GAME_SPEC.md` + twin already carried "leaves the world" — no build-code edit; `KNOWN_ISSUES.md` Q7 kept verbatim as the resolution record. See `CHANGELOG.md`. |
